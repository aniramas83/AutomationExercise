...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "PostApi", @"For the API test, please use the Australia Post API to calculate shipping costs for parcels of
different weights to at least three countries. In your test add what you believe should be verified/checked as part of the API.
	https://digitalapi.auspost.com.au/postage/v4/catalogue/service.json?category=INTERNATIONAL&from=AU&to=NZ", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void ValidatePostalCostToDifferentCountries(string fromCountry, string toCountry, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("FromCountry", fromCountry);
            argumentsOfScenario.Add("ToCountry", toCountry);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Validate postal cost to different countries", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line 7
 testRunner.When("I call australia post api with:", ((string)(null)), table5, "When ");
#line hidden
#line 10
